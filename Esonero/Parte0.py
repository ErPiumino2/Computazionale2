...
# Data and plot
t, x, y, e = np.loadtxt('/workspaces/Computazionale/Esonero/File/Parte0dt0.01.dat', usecols=(0, 1, 2, 3), unpack=True)
ax[0,0].plot(x, y, color='darkslategrey', label='(x(t), y(t))')
