...
fig.suptitle('Spazio fasi di Pendolo smorzato con Eulero-Cromer per vari $\Delta t$')

# Data per spazio delle fasi
x_1, y_1 = np.loadtxt('PendoloSmorzato0.001.dat', usecols=(0, 1), unpack=True)
x_2, y_2 = np.loadtxt('PendoloSmorzato0.002.dat', usecols=(0, 1), unpack=True)
x_3, y_3 = np.loadtxt('PendoloSmorzato0.003.dat', usecols=(0, 1), unpack=True)
x_4, y_4 = np.loadtxt('PendoloSmorzato0.004.dat', usecols=(0, 1), unpack=True)
a_1, b_1 = np.loadtxt('PendoloSmorzato0.001.dat', usecols=(0, 3), unpack=True)
a_2, b_2 = np.loadtxt('PendoloSmorzato0.002.dat', usecols=(0, 3), unpack=True)
a_3, b_3 = np.loadtxt('PendoloSmorzato0.003.dat', usecols=(0, 3), unpack=True)
a_4, b_4 = np.loadtxt('PendoloSmorzato0.004.dat', usecols=(0, 3), unpack=True)
...
plt.savefig('SpazioFasi_PendoloSmorzato.pdf')
plt.show()