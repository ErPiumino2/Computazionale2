...
# Data per x(t)
x1, y1 = np.loadtxt('Verlet0.001.dat', usecols=(2, 0), unpack=True)
x2, y2 = np.loadtxt('Verlet0.002.dat', usecols=(2, 0), unpack=True)
x3, y3 = np.loadtxt('Verlet0.003.dat', usecols=(2, 0), unpack=True)
x4, y4 = np.loadtxt('Verlet0.004.dat', usecols=(2, 0), unpack=True)

# Data per E(t)
e1, te1 = np.loadtxt('Verlet0.001.dat', usecols=(2, 3), unpack=True)
e2, te2 = np.loadtxt('Verlet0.002.dat', usecols=(2, 3), unpack=True)
e3, te3 = np.loadtxt('Verlet0.003.dat', usecols=(2, 3), unpack=True)
e4, te4 = np.loadtxt('Verlet0.004.dat', usecols=(2, 3), unpack=True)
