...
fig.suptitle('Verlet Autosufficiente per vari $\Delta t$')

# Data per x(t)
x1, y1 = np.loadtxt('VerletAuto0.001.dat', usecols=(2, 0), unpack=True)
x2, y2 = np.loadtxt('VerletAuto0.002.dat', usecols=(2, 0), unpack=True)
x3, y3 = np.loadtxt('VerletAuto0.003.dat', usecols=(2, 0), unpack=True)
x4, y4 = np.loadtxt('VerletAuto0.004.dat', usecols=(2, 0), unpack=True)

# Data per E(t)
e1, te1 = np.loadtxt('VerletAuto0.001.dat', usecols=(2, 3), unpack=True)
e2, te2 = np.loadtxt('VerletAuto0.002.dat', usecols=(2, 3), unpack=True)
e3, te3 = np.loadtxt('VerletAuto0.003.dat', usecols=(2, 3), unpack=True)
e4, te4 = np.loadtxt('VerletAuto0.004.dat', usecols=(2, 3), unpack=True)
...
plt.tight_layout() 
plt.savefig('VerletAuto.pdf')
plt.show() 

#Codice per il fit
x,y=np.loadtxt("fitAuto.dat",unpack=True)
...
plt.text(5.5, 14, '$m=2.0161$', fontsize = 10)
plt.legend(loc='upper left')
plt.savefig('FitVerletAuto.pdf')
plt.show()
